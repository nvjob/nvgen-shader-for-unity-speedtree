...
Shader "NVGen/SpeedTree/Branch/Specular, NormalMap, OcclusionMap, LOD, Shadow, Optimized" {
...
fixed4 _Color;
half _Shininess, _IntensityNm, _IntensityOc;
...
fixed occcol = tex2D(_OcclusionMap, IN.uv_MainTex).r;
occcol *= _IntensityOc;
diffuseColor *= occcol;
